"""
AutoCoT Experimental Combinations Runner (§3.2.2 & §4)

Purpose: Systematic execution of all AutoCoT experimental configurations for PHQ-8 prediction
...
This script automates the execution of all AutoCoT experimental combinations mentioned in the paper:
...
Usage:
    ...
    # Runs all 32 experimental combinations sequentially
...
- experiments/run_autoCOT_combinations.py — Alternative runner script

Note: This script executes experiments sequentially to avoid resource conflicts.
      Total runtime: ~8-12 hours depending on dataset size and API rate limits.
"""
